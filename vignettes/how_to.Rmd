...
primates.captive <- subset_archive(column = list('taxon', 'captivity'), values = list('Primate', 'Captive'), return.intxdata.only = T)

primates.natural <- subset_archive(column = list('taxon', 'captivity'), values = list('Primate', 'Natural'), return.intxdata.only = T)
...
legend(pch = 16, legend = c('Captive', 'Natural'), col = c('darkorchid4', 'firebrick'), x = 'bottomright')
